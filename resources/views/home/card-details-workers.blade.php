<div class="row  shadow p-3 mb-4 bg-white rounded-bottom">
    ...
    <x-colorful-card :title="'Personal'" :count="intval($Workers_statuses['Activo']['Total'])" :subtitle="' Personal activo '" :color="'card-1'" :link="route('worker.index')">
        <x-slot name="icon">
    ...
    <x-colorful-card :title="'Femenino'" :count="intval($Workers_statuses['Activo']['Female'])" :subtitle="'Activo femenino '" :color="'card-female'" :link="route('worker.index', ['param' => 'Femenino'])">
        <x-slot name="icon">
            <svg xmlns="http://www.w3.org/2000/svg" width="25" height="25" viewBox="0 0 24 24">
    ...
    <x-colorful-card :title="'Masculino'" :count="intval($Workers_statuses['Activo']['Male'])" :subtitle="'Activo masculino '" :color="'card-male'" :link="route('worker.index', ['param' => 'Masculino'])">
        <x-slot name="icon">
