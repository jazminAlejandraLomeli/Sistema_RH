<div class="card">
    ...
    <div class="card-body Personal-Data">
        ...
        <form id="formEdit" action="#" method="POST">
            @csrf
            <input type="hidden" id="id" value="{{$honorario->id}}">
            <div class="row ">
                    ...
                    <div class="row">
                        <div class="col-12">
                            <abbr data-bs-toggle="tooltip" data-bs-html="true"
                                ...
                                <x-input id="code" label="Código" value="{{ $honorario->codigo }}"
            ...
            <div class="col-12 d-lg-flex justify-content-lg-end mt-3">
                <div class="d-flex flex-column flex-lg-row gap-3">
                    ...
                    <button type="submit" class="btn fst-italic  animated-icon  button-save" id="personal-data">
