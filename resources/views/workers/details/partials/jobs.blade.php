 @foreach ($Worker->trabajos as $job)
     <div class="row mt-1 card animate__animated animate__fadeInDown p-4 mw-75 mx-auto">
         <x-section-divider text="{{ $job->principal == 1 ? 'Nombramiento Principal' : 'Nombramiento Secundario' }}"
             color="#0284c7" />
         ...
         <div class="row mt-3 px-0 ">
             <div class="col-12 col-md-6  ">
                 <x-icon-cont
                     icon='<svg xmlns="http://www.w3.org/2000/svg" width="30" height="30" viewBox="0 0 32 32"><path fill="none" stroke="#373CC4" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M30 8H2v18h28ZM20 8s0-4-4-4s-4 4-4 4M8 26V8m16 18V8"/></svg>'
                     label="Nombramiento" text="{{ $job->nombramientoPersona->nombre }}"
                     id="nombre.{{ $job->principal }}" />

                 <x-icon-cont
                     icon='<svg xmlns="http://www.w3.org/2000/svg" width="30" height="30" viewBox="0 0 32 32"><path fill="#373CC4" d="M27 22.141V18a2 2 0 0 0-2-2h-8v-4h2a2 2 0 0 0 2-2V4a2 2 0 0 0-2-2h-6a2 2 0 0 0-2 2v6a2 2 0 0 0 2 2h2v4H7a2 2 0 0 0-2 2v4.142a4 4 0 1 0 2 0V18h8v4.142a4 4 0 1 0 2 0V18h8v4.141a4 4 0 1 0 2 0M13 4h6l.001 6H13ZM8 26a2 2 0 1 1-2-2a2 2 0 0 1 2 2m10 0a2 2 0 1 1-2-2a2.003 2.003 0 0 1 2 2m8 2a2 2 0 1 1 2-2a2 2 0 0 1-2 2"/></svg>'
                     label="Categoría" text="{{ $job->trabajoCategoria->nombre }}"
                     id="cate_name.{{ $job->principal }}" />

                 <span id="id_cate" class="d-none">{{ $job->trabajoCategoria->id }} </span>

                 @if ($job->distincionAdicional)
                     <x-icon-cont
                         icon='<svg xmlns="http://www.w3.org/2000/svg" width="30" height="30" viewBox="0 0 24 24"><path fill="#373CC4" d="M1 3a2 2 0 0 1 2-2h6.5a2 2 0 0 1 2 2v6.5a2 2 0 0 1-2 2H7v4.063C7 16.355 7.644 17 8.438 17H12.5v-2.5a2 2 0 0 1 2-2H21a2 2 0 0 1 2 2V21a2 2 0 0 1-2 2h-6.5a2 2 0 0 1-2-2v-2.5H8.437A2.94 2.94 0 0 1 5.5 15.562V11.5H3a2 2 0 0 1-2-2Zm2-.5a.5.5 0 0 0-.5.5v6.5a.5.5 0 0 0 .5.5h6.5a.5.5 0 0 0 .5-.5V3a.5.5 0 0 0-.5-.5ZM14.5 14a.5.5 0 0 0-.5.5V21a.5.5 0 0 0 .5.5H21a.5.5 0 0 0 .5-.5v-6.5a.5.5 0 0 0-.5-.5Z"/></svg>'
                         label="Distinción adicional" text="{{ $job->distincionAdicional->nombre }}"
                         id="dist.{{ $job->principal }}" />
                 @else
                     <x-icon-cont
                         icon='<svg xmlns="http://www.w3.org/2000/svg" width="30" height="30" viewBox="0 0 24 24"><path fill="#373CC4" d="M1 3a2 2 0 0 1 2-2h6.5a2 2 0 0 1 2 2v6.5a2 2 0 0 1-2 2H7v4.063C7 16.355 7.644 17 8.438 17H12.5v-2.5a2 2 0 0 1 2-2H21a2 2 0 0 1 2 2V21a2 2 0 0 1-2 2h-6.5a2 2 0 0 1-2-2v-2.5H8.437A2.94 2.94 0 0 1 5.5 15.562V11.5H3a2 2 0 0 1-2-2Zm2-.5a.5.5 0 0 0-.5.5v6.5a.5.5 0 0 0 .5.5h6.5a.5.5 0 0 0 .5-.5V3a.5.5 0 0 0-.5-.5ZM14.5 14a.5.5 0 0 0-.5.5V21a.5.5 0 0 0 .5.5H21a.5.5 0 0 0 .5-.5v-6.5a.5.5 0 0 0-.5-.5Z"/></svg>'
                         label="Distinción adicional" text="{{ '--' }}" id="dist.{{ $job->principal }}" />
                 @endif


                 <x-icon-cont
                     icon='<svg xmlns="http://www.w3.org/2000/svg" width="30" height="30" viewBox="0 0 1024 1024"><path fill="#373CC4" d="M512 512a192 192 0 1 0 0-384a192 192 0 0 0 0 384m0 64a256 256 0 1 1 0-512a256 256 0 0 1 0 512"/><path fill="#373CC4" d="M512 512a32 32 0 0 1 32 32v256a32 32 0 1 1-64 0V544a32 32 0 0 1 32-32"/><path fill="#373CC4" d="M384 649.088v64.96C269.76 732.352 192 771.904 192 800c0 37.696 139.904 96 320 96s320-58.304 320-96c0-28.16-77.76-67.648-192-85.952v-64.96C789.12 671.04 896 730.368 896 800c0 88.32-171.904 160-384 160s-384-71.68-384-160c0-69.696 106.88-128.96 256-150.912"/></svg>'
                     label="Área de adscripción" text="{{ $job->area_distincion ?? '--' }}"
                     id="P_area.{{ $job->principal }}" />

                 @php
                     $color = '';
                     switch ($job->estado->nombre) {
                         case 'Inactivo':
                             $color = '#dc2626';
                             break;
                 ...
                 <x-icon-cont
                     ...
                     label="Estatus laboral" text="{{ $job->estado->nombre }}"
                     id="Person_Status.{{ $job->principal }}" />



                 {{-- Semblanza del profesor  ptc o ta --}}
                 @if ($job->nombramiento == 6 || $job->nombramiento == 4)
                     <div class="col-12">
                         <div class="row">
                             ...
                             <div class="col-12">
                                 <div class="semblanza shadow-sm p-4 bg-light rounded-3">
                                     {{ $job->semblanza ?? 'No se ha agregado la semblanza' }}
                                 </div>
                             </div>
             ...
             <div class="col-12 col-md-6  ">
                 <div class="row pt-2">
                     <div class="form-group col-6">
                         <x-icon-cont
                             icon='<svg xmlns="http://www.w3.org/2000/svg" width="30" height="30" viewBox="0 0 24 24"><path fill="#373CC4" d="M9 9V7h9v2zm0 3v-2h9v2zm3 8H5zm0 2H6q-1.25 0-2.125-.875T3 19v-3h3V2h15v9.025q-.5-.05-1.012.038t-.988.312V4H8v12h6l-2 2H5v1q0 .425.288.713T6 20h6zm2 0v-3.075l5.525-5.5q.225-.225.5-.325t.55-.1q.3 0 .575.113t.5.337l.925.925q.2.225.313.5t.112.55t-.1.563t-.325.512l-5.5 5.5zm7.5-6.575l-.925-.925zm-6 5.075h.95l3.025-3.05l-.45-.475l-.475-.45l-3.05 3.025zm3.525-3.525l-.475-.45l.925.925z"/></svg>'
                             label="T. Contrato" text="{{ $job->tipo_contrato }} " id="P_contrato" />
                     </div>
                     ...
                     <div class="form-group col-6">
                         ...
                         @php
                             $fecha_termino = '';
                             if ($job->fecha_termino != null) {
                                 $fecha_termino = \Carbon\Carbon::parse($job->fecha_termino)
                                     ->locale('es')
                                     ->isoFormat('LL');
                             } else {
                                 $fecha_termino = '--';
                             ...
                             if ($job->fecha_termino == null || $job->fecha_termino == '') {
                                 $color = '#373CC4';
                             } elseif ($job->fecha_termino < now()) {
                                 $color = '#dc2626';
                             } else {
                                 $color = '#373CC4';
                             }
                 ...
                 <div class="row">
                     <div class="form-group col-6">
                         ...
                         <x-icon-cont
                             icon='<svg xmlns="http://www.w3.org/2000/svg" width="30" height="30" viewBox="0 0 24 24"><g fill="none" stroke="#373CC4" stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" color="#059669"><path d="M11.007 21H9.605c-3.585 0-5.377 0-6.491-1.135S2 16.903 2 13.25s0-5.48 1.114-6.615S6.02 5.5 9.605 5.5h3.803c3.585 0 5.378 0 6.492 1.135c.857.873 1.054 2.156 1.1 4.365"/><path d="m18.85 18.85l-1.35-.9V15.7M13 17.5a4.5 4.5 0 1 0 9 0a4.5 4.5 0 0 0-9 0m3-12l-.1-.31c-.494-1.54-.742-2.31-1.331-2.75C13.979 2 13.197 2 11.632 2h-.264c-1.565 0-2.348 0-2.937.44c-.59.44-.837 1.21-1.332 2.75L7 5.5"/></g></svg>'
                             label="H. de trabajo" text="{{ $job->horas_trabajo ?? '--' }}" id="P_horas" />

                     </div>
                     <div class="form-group col-6">

                         <x-icon-cont
                             icon='<svg xmlns="http://www.w3.org/2000/svg" width="30" height="30" viewBox="0 0 16 16"><path fill="none" stroke="#373CC4" d="M14.5 8A6.5 6.5 0 1 0 8 14.5M8 4v4H4m7.5 1.5v2m3 0a3 3 0 1 1-6 0a3 3 0 0 1 6 0Zm-3 1.25h.005v.005H11.5zm.25 0a.25.25 0 1 1-.5 0a.25.25 0 0 1 .5 0Z"/></svg>'
                             label="Turno" text="{{ $job->turno ?? '--' }}" id="P_turno" />
                     </div>
                 </div>

                 <div class="row">
                     @php
                         $horarios = explode(',', $job->horario_oficial);
                     ...
                     <div class="form-group pt-2 col-12 mb-2">
                         ...
                         <div class="row">
                             <div class="col-md-{{ empty($secondHalf) ? '12' : '6' }}">
                 ...
                 @if ($job->nombramiento == 6 || $job->nombramiento == 4)
                     <div class="row px-0 mx-0">
                         ...
                         @if (empty($job->departamento))
                             <ul class="list-group shadow-sm p-1 bg-light rounded-3 mb-2">
                                 @foreach ($job->departamento as $departamento)
                                     <li
                                         class="list-group-item border-0 d-flex align-items-center gap-1 bg-transparent ">
                         ...
                         @else
                             <div class="">
                                 @if ($job->departamento->isNotEmpty())
                                     <ul class="list-group shadow-sm p-1 bg-light rounded-3 mb-2">
                                         @foreach ($job->departamento as $departamento)
                                             <li
                                                 class="list-group-item border-0 d-flex align-items-center gap-1 bg-transparent ">
             ...
             <div class="d-flex flex-column flex-lg-row gap-3">
                 ...
                 @if ($job->principal == 0)
                     <div data-bs-toggle="tooltip" data-bs-html="true"
                         data-bs-title="Intercambiar los Nombramientos">

                         <x-clear-button-component id="button-switch" text="Intercambiar"
                             data-work-id="{{ $job->id }}" data-worker-id="{{ $Worker->id }}" />
                     </div>
                 @endif

                 <div data-bs-toggle="tooltip" data-bs-html="true" data-bs-title="Ver detalles del nombramiento">
                     <x-save-button-component text="Editar" id="address-data" description="Ver detalles y editar datos"
                         href="{{ route('worker.detalles.edit-job', $job->id) }}" />
                 </div>
             </div>
