 @role('Administrador')
     <div class="mt-2 col-12 mb-2 d-flex justify-content-end">
         @if (!empty($Principal) && empty($Trabajo))
             ...
             <div>
                 <abbr title="Agregar segundo nombramiento.">
                     <button class="btn fst-normal px-2 animated-icon button-add" id="N-Secundario">
                         <i class="fa-solid fa-circle-plus"></i> Nombramiento
                     </button>
                 </abbr>
             </div>
         @endif
 ...
 <div class="card shadow-sm animate__animated animate__fadeInDown">
     <div class="card-body">
         ...
         <div class="row pt-2">
             <div class="col-12 col-md-6 col-xl-6">
                 ...
                 <div class="row">
                     ...
                     <div class="form-group col-6">
                         ...
                         <x-icon-cont
                             icon='<svg xmlns="http://www.w3.org/2000/svg" width="30" height="30" viewBox="0 0 24 24"><path fill="none" stroke="#373CC4" stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="M19 20.75a1 1 0 0 0 1-1v-1.246c.004-2.806-3.974-5.004-8-5.004s-8 2.198-8 5.004v1.246a1 1 0 0 0 1 1zM15.604 6.854a3.604 3.604 0 1 1-7.208 0a3.604 3.604 0 0 1 7.208 0"/></svg>'
                             label="Edad" text="{{ $edad }} años" id="Person_edad" />
                     </div>
                 </div>
             ...
             <div class="col-12 col-md-6 col-xl-6">
                 ...
                 <div class="row pt-2">
                     ...
                     <div class="form-group col-6">
                         ...
                         <x-icon-cont
                             ...
                             label="Antigüedad" text="{{ $Antiguedad }} años" id="Person_antigüedad" />

                     </div>
                 </div>

                 <p class="text-center mt-2 fw-normal"> Contacto de emergencia</p>
                 ...
                 <x-icon-cont
                     ...
                     label="Nombre" text="{{ $persona->nombre_emergencia ?? '--' }}" id="name_emer" />
                 ...
                 <div class="row">
                     <div class="form-group col-6">
                         ...
                         <x-icon-cont
                             ...
                             label="Parentesco" text="{{ $persona->e_parentesco ?? '--' }}" id="parentesco_emer" />
                     ...
                     <div class="form-group col-6">
                         ...
                         <x-icon-cont
                             ...
                             label="Teléfono" text="{{ $persona->tel_emergencia ?? '--' }}" id="Person_Telf" />
                     </div>
                 </div>
         ...
         {{-- <h5 class="text-center pt-2">Datos Personales</h5>
         <div class="bg-color-form pb-1 pb-2">
             <div class="col-lg-6 col-md-6 col-sm-12">
                 <div class="form-group pt-2 col-12">
                     <p class="fw-bold mb-0">Nombre Completo:</p>
                     <div class="mt-0" id="Person_Name">{{ $persona->nombre }}</div>
                 </div>
                 <div class="form-group pt-2 col-12">
                     <p class="fw-bold mb-0">Correo:</p>
                     <div class="mt-0" id="Person_Correo">{{ $persona->correo ?? '--' }}</div>
                 </div>
                 <div class="form-group pt-2 col-12">
                     <p class="fw-bold mb-0">Grado de estudios:</p>
                     <div class="mt-0" id="Person_Grade">{{ $persona->ultimo_grado }}</div>
                 </div>
                 <div class="form-group">
                     <div class="row pt-2">
                         <div class="form-group col-md-6 col-sm-12">
                             <p class="fw-bold mb-0">Fecha de nacimiento:</p>
                             <div class="mt-0">
                                 {{ \Carbon\Carbon::parse($persona->fecha_nacimiento)->locale('es')->isoFormat('LL') }}
                             </div>
                             <span class="d-none" id="Person_Birthday">{{ $persona->fecha_nacimiento }}</span>
                         </div>
                         <div class="form-group col-md-6 col-sm-12">
                             <p class="fw-bold mb-0">Edad:</p>
                             <div class="mt-0" id="Person_edad">{{ $edad }} años </div>
                         </div>
                     </div>
                 </div>
                 <div class="form-group pt-2 col-md-6 col-sm-12">
                     <p class="fw-bold mb-0">Estatus laboral:</p>
                     <div class="mt-0" id="Person_Status">{{ $persona->estado->nombre }}</div>
                 </div>
             </div>
             <div class="col-lg-6 col-md-6 col-sm-12">
                 ...
                 <div class="form-group">
                     <div class="row pt-2">
                         <div class="form-group col-md-6 col-sm-12">
                             ...
                             <div class="mt-0" id="Person_Code">{{ $persona->codigo }}</div>
                         </div>
                         <div class="form-group col-md-6 col-sm-12">
                             <p class="fw-bold mb-0">Género:</p>
                             <div class="mt-0" id="Person_sex">{{ $persona->sexo }}</div>
                         </div>
                     </div>
                 </div>
                 <div class="form-group">
                     <div class="row pt-2">
                         <div class="form-group col-md-6 col-sm-12">
                             ...
                             <div class="mt-0">
                                 {{ \Carbon\Carbon::parse($persona->fecha_ingreso)->locale('es')->isoFormat('LL') }}

                             </div>
                             <span class="d-none" id="Person_Date">{{ $persona->fecha_ingreso }}</span>
                         </div>
                         <div class="form-group col-md-6 col-sm-12">
                             <p class="fw-bold mb-0">Antigüedad:</p>
                             <div class="mt-0" id="Person_antigüedad">{{ $Antiguedad }} años </div>
                         </div>
                     </div>
                 </div>

                 <div class="form-group mt-2">
                     <p class="text-center mt-0"> Contacto de emergencia</p>
                     <div class="row">
                         <div class="form-group col-md-6 col-sm-12">
                             <p class="fw-bold mb-0">Nombre:</p>
                             <div class="mt-0" id="name_emer">{{ $persona->nombre_emergencia ?? '--' }}
                             </div>
                         </div>
                         <div class="form-group col-md-6 col-sm-12">
                             <p class="fw-bold mb-0">Teléfono:</p>
                             <div class="mt-0" id="Person_Telf">{{ $persona->tel_emergencia ?? '--' }}
                             </div>
                         </div>
                     </div>
                 </div>
