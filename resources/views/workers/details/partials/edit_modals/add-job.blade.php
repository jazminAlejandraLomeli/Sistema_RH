    ...
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <div class="row mt-2">
                    <div class="col-12 col-md-6 col-xl-6">
                        ...
                        <x-select id="nombramientos" label="Nombramiento" name="nombramientos" :options="['' => 'Selecciona un nombramiento'] +
                            $nombramientos->pluck('nombre', 'id')->toArray()"
                            requiredIndicator="true" />

                        <label class="mt-2" for="categoria" style="display: block;">Categorias <span
                        ...
                        <div class="form-group d-none campo-distincion mt-2">
                            ...
                            <select class="form-control form-disabled Distincion_Adicional" name="Distincion_Adicional"
                        ...
                        <x-input id="dep" label="Departamento /Área de Adscripción" name="dep"
                    ...
                    <div class="col-12 col-md-6 col-xl-6 ">
                        ...
                        <div class="row">
                            <div class="col-6">
                                ...
                                <x-select id="new_contrato" label="Tipo de contrato" name="new_contrato"
                                    :options="['' => 'Selecciona un tipo'] +
                                        $Contrato->pluck('nombre', 'id')->toArray()" requiredIndicator="true" disableIndicator="true" />

                            </div>
                            <div class="col-6 d-none Contrato">

                                <x-input type="date" id="fecha_termino_new" label="F. de termino"
                                    name="fecha_termino_new" requiredIndicator="true" disableIndicator="true" />
         ...
         <div class="col-12 d-none extras-container">
                    <hr class="mt-3" />
                    <p class="pt-1 mb-0 text-center  instructions">Selecciona los departamentos a los cuales impartirá
                        clases
